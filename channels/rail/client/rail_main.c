 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT rail_client_exec(RailClientContext* context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT rail_client_get_appid_req(RailClientContext* context,
...
BOOL VCAPITYPE VirtualChannelEntryEx(PCHANNEL_ENTRY_POINTS pEntryPoints, PVOID pInitHandle)
{
	    ...
	    (pEntryPointsEx->MagicNumber == FREERDP_CHANNEL_MAGIC_NUMBER))
	{
		...
		context->ClientExec = rail_client_exec;
		...
		context->ClientGetAppidReq = rail_client_get_appid_req;
